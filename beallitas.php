...
if($kutyam->Avatar(200) != "<img src=http://". $_SERVER['SERVER_NAME'] ."/pic/user/avatar.jpg border=0 width=200 height=200>")
{
	$kep = $kutyam->Avatar(200) ."<br><a href=inc/keptorol.php class='feherlink'>Kép törlése</a>";
}
else
{
	$kep = $kutyam->Avatar(200);
}
...
<tr><td align=center width=300 colspan=2>". $kep ."</td></tr>
