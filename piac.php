...
$adat.="A piacon kutyákat adhatsz-vehetsz. A piaci árnak csak 80%-át kapod meg, mivel a kereskedésnek vannak költségei. Tehát ha 5 csontért eladtál egy kutyát csak 4 csont kerül jóváírásra nálad. Az eladott kutyáért járó pénzt mindig az a kutya kapja, akivel kiraktad a piacra az eladó kutyát.<br><br>";
if(substr_count($kutya->kutya_tanul,"KE")==0){
...
if($elado->kutya_betuszin=="774411"){
$nev1=htmlentities($elado->kutya_nev);
}else{
$nev1="<font color=#". $elado->kutya_betuszin .">". htmlentities($elado->kutya_nev) ."</font>";
}
...
$event="<a href=inc/visszavon.php?id=". $elado->piac_id ." class='feherlink'>Visszavonom</a>";
}else{
$event="<a href=inc/kutyavesz.php?id=". $elado->piac_id ." class='feherlink'>Megveszem</a>";

}
$adat.="<tr background=pic/". $szin .".gif><td><img src=pic/kutyak/". kutyaszamtofile($elado->kutya_fajta) . $elado->kutya_szin .".png width=30 heigth=20></td><td align=center><a href=kutyak.php?id=". $elado->kutya_id ." class='feherlink'>". $nev1 . "</a></td>".$nev2 ."<td align=center>". $elado->kutya_kor ." nap</td><td align=center>". penz($elado->kutya_penz) ."</td><td align=center>". $elado->kutya_egeszseg ."%</td><td align=center>". $elado->kutya_suly ."%</td><td align=center>". $elado->piac_ar ." csont</td><td><a href = \"javascript:void(0)\" onclick = \"info(". $elado->kutya_id .")\" class=\"feherlink\">Részletek...</a></td><td align=center>". $event ."</td></tr>";
if($szin=="keret3")
      {
      $szin="hatter8";
      }else{
